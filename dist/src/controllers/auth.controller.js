                ...
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        if (token) {
                            ...
                            return [2 /*return*/, res.status(200).json({ usuario: { 'id': user.user_id, 'nombre': user.user_name, 'apellido': user.user_lastname, 'estado': user.user_status, 'img': (_a = user.file) === null || _a === void 0 ? void 0 : _a.cloudinary_url, 'rol': (_b = user.rol_user.id_rol) !== null && _b !== void 0 ? _b : "", result: token } })];
                        }
                        return [3 /*break*/, 4];
                    case 3:
                        error_1 = _c.sent();
