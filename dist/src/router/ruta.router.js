...
router.get("/rutas", function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, app_data_source_1.default.getRepository(ruta_entity_1.Ruta).find()];
                case 1:
                    rutas = _a.sent();
                    res.json(rutas);
                    return [2 /*return*/];
...
router.get("/ruta/:id", function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, app_data_source_1.default.getRepository(ruta_entity_1.Ruta).findOneBy({
...
router.delete("/ruta/:id", function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var results;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, app_data_source_1.default.getRepository(ruta_entity_1.Ruta).delete(req.params.id)];
                case 1:
                    results = _a.sent();
                    return [2 /*return*/, res.send(results)];
            }
